...
public final class GameLoop extends AbstractLoop
{
    ...
    private EventMappings playerOneMappings;

    private EventMappings playerTwoMappings;
    ...
    public GameLoop(Environment environment)
    {
    ...
    {
        this.playerOneMappings = EventMappings.createForPlayerOne(environment.getConfig());
        this.playerTwoMappings = EventMappings.createForPlayerTwo(environment.getConfig());
    }
    ...
    {
        playerOneInput = Input.create(environment.getKeyboard(), environment.getTimer());
        playerOneInput.setEventMappings(playerOneMappings);
        playerTwoInput = Input.create(environment.getKeyboard(), environment.getTimer());
        playerTwoInput.setEventMappings(playerTwoMappings);
    }
