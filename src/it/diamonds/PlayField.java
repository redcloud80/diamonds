...
public final class PlayField
{
    ...
    private PlayField(Environment environment, InputReactor inputReactor, RandomGenerator randomGenerator, PlayFieldDescriptor descriptor)
    {
        ...
        gridRenderer = new GridRenderer(environment, descriptor.getGridOrigin(), grid);
        gridController = new GridController(environment, gridRenderer, inputReactor, GemQueue.create(environment, randomGenerator));
    ...
    {
        gridController.update(timestamp, scoreCalculator, gridRenderer.getGrid());
    ...
    public void fillLayerManager(LayerManager layerManager)
    {
        ...
        layerManager.addSimpleLayer(gridRenderer);
