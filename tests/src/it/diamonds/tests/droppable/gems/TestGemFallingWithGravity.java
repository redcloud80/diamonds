...
public class TestGemFallingWithGravity extends GridTestCase
{
    public void testGemFallingWithGravity()
    {
        ...
        float gemY = gem.getAnimatedSprite().getSprite().getPosition().getY();

        dropGemsPair();

        controller.update(environment.getTimer().getTime(), scoreCalculator);

        float newGemY = gem.getAnimatedSprite().getSprite().getPosition().getY();
    ...
    public void testBigGemFallingWithGravity()
    {
        ...
        float gemY = bigGem.getAnimatedSprite().getSprite().getPosition().getY();
        dropGemsPair();

        controller.update(environment.getTimer().getTime(), scoreCalculator);

        assertEquals("Gem must be moved", gemY + getDeltaYStrongestGravity(), bigGem.getAnimatedSprite().getSprite().getPosition().getY(), 0.001f);
    }
    ...
    public void testGemFallingWithGravityToGridBottom()
    {
        ...
        assertEquals("Gem must be on the bottom", gemY, gem.getAnimatedSprite().getSprite().getPosition().getY(), 0.001f);
    }
    ...
    public void testGemFallingWithGravityFromHigherToGridBottom()
    {
        ...
        assertEquals("Gem must be on the bottom", gemY, gem1.getAnimatedSprite().getSprite().getPosition().getY(), 0.001f);
    }
    ...
    public void testBigGemFallingWithGravityToGridBottom()
    {
        ...
        assertEquals("Gem must be moved", gemY, bigGem.getAnimatedSprite().getSprite().getPosition().getY(), 0.001f);
    }
    ...
    {
        controller.getGrid().setStrongerGravity();
    ...
    public void testDroppedGemCanMoveDown()
    {
        ...
        gem.getAnimatedSprite().getSprite().setPosition(gem.getAnimatedSprite().getSprite().getPosition().getX(), grid.getRowUpperBound(12)
            - 2 * grid.getActualGravity());
