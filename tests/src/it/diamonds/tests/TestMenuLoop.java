...
public class TestMenuLoop extends EnvironmentTestCase
{
    ...
    {
        assertEquals(menuLoop.getMainMenu().getSelectedItem(), MainMenu.VERSUS_MODE);
    }
    ...
    {
        menuLoop.getMainMenu().selectMenuItem(MainMenu.QUIT);
    ...
    public void testKeyboardIsUpdatedAfterLoopStep()
    {
        menuLoop.loopStep();
    ...
    public void testMainMenuReactionToDownInput()
    {
        ...
        assertEquals(MainMenu.NETPLAY, menuLoop.getMainMenu().getSelectedItem());
    }
    ...
    {
        menuLoop.notify(Event.create(Code.KEY_UP, State.PRESSED));
        assertEquals(MainMenu.QUIT, menuLoop.getMainMenu().getSelectedItem());
    }
    ...
    public void testChangeMenuItemPressAndRealease()
    {
        ...
        assertEquals(MainMenu.VERSUS_MODE, menuLoop.getMainMenu().getSelectedItem());
    }
    ...
    public void testExitLoop()
    {
        ...
        assertFalse(mockKeyboard.isListenerRegistred(menuLoop));
    }
}
