...
public class TestIncomingStones extends GridTestCase
{
    ...
    public void setUp()
    {
        ...
        GameLoop gameLoop = new GameLoop(environment, new InputFactory(environment));
    ...
    private void dropAndRemoveGemsPair(GridController controller1)
    {
        ...
        Grid grid1 = controller1.getGridRenderer().getGrid();
    ...
    {
        grid = playField.getGridController().getGridRenderer().getGrid();
    ...
    public void testWarningBoxIsHideAfterPairGemsInsert()
    {
        ...
        playField.getGridController().insertNewGemsPair(grid);
    ...
    public void testWarningBoxAfterBigGemCrush()
    {
        ...
        grid = opponentPlayField.getGridController().getGridRenderer().getGrid();
    ...
    {
        while (droppedGemCanMoveDown(playField.getGridController().getGridRenderer().getGrid()))
        {
            update(playField);
        }
        update(playField);
    ...
    public void testPatternDoesNotChange()
    {
        ...
        {
            Droppable stone1 = grid.getDroppableAt(Cell.create(13, column));
            Droppable stone2 = grid.getDroppableAt(Cell.create(12, column));
