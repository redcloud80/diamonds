...
public class TestPlayField extends GridTestCase
{
    ...
    public void testDoubleUpdateOnTwoTimingElapsed()
    {
        ...
        float yStep = oldY
            - playField.getGridController().getGemsPair().getPivot().getAnimatedSprite().getSprite().getPosition().getY();
        oldY = playField.getGridController().getGemsPair().getPivot().getAnimatedSprite().getSprite().getPosition().getY();
