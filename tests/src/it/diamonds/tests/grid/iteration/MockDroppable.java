...
public class MockDroppable implements Droppable
{
    ...
    private Grid lastGridExtendedOn = null;
    ...
    public void setPositionInGridLocalSpace(float x, float y)
    {
        // TODO Auto-generated method stub
    ...
    public Grid getLastGridExtendedOn()
    {
        return this.lastGridExtendedOn;
    }
}
