...
public class TestTransformingIteration extends DroppableIterationTestCase
{
    ...
    public void setUp()
    {
        ...
        GridRenderer gridRenderer = new GridRenderer(environment, gridPosition);
        grid = gridRenderer.getGrid();
    ...
    public void testDroppableLeavedInRightPlace()
    {
        ...
        grid.insertDroppable(flashingGem);
        float oldY = flashingGem.getAnimatedSprite().getPosition().getY();
        grid.updateFalls();
        grid.runIteration(iteration);
        float newY = flashingGem.getAnimatedSprite().getPosition().getY();
