...
public class TestGridNew extends EnvironmentTestCase
{
    ...
    {
        super.setUp();
        grid = new Grid(environment, gridOrigin);
    }
    ...
    {
        assertEquals("getHeight returns wrong value", Cell.SIZE_IN_PIXELS
            * grid.getNumberOfRows(), grid.getHeight());
    }
