...
public class TestInputDevice extends EnvironmentTestCase
{
    ...
    {
        EventMappings keyMappings = new EventMappings();
    ...
    {
        EventMappings keyMappings1 = new EventMappings();
        EventMappings keyMappings2 = new EventMappings();
        EventMappings keyMappings3 = new EventMappings();
